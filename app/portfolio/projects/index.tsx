  ...
  const projects = [
    {
      id: 1,
      title: "Nexovea",
      description: "An AI-powered exam preparation platform that helps students and professionals prepare for academic, international, and professional certification exams — including JAMB, WAEC, NECO, SAT, IELTS, ICAN, and Azure/AWS certifications — with realistic CBT simulations, AI-generated mock exams, and performance analytics.",
      image: "/images/nexovea.png",
      category: "Edtech",
      details: "I designed and developed Nexovea, an AI-driven exam readiness platform serving over 25 academic, international, and professional exam bodies. The platform gives learners access to a growing library of verified past questions, AI-generated mock exams that simulate the real test experience, and a Smart CBT Simulator with timers, question maps, and answer navigation modeled on actual exam interfaces.\n\nOn the backend, the system powers auto-marking, instant feedback, and detailed answer explanations, while a personalized analytics engine tracks accuracy and improvement over time, surfaces weak topics, and computes an Exam Readiness Index so users know when they're truly prepared. It also includes career and course recommendation tools to help students align their exam prep with future goals.\n\nThe platform is built for scale and responsiveness across devices, supporting thousands of active learners and tens of thousands of practice questions, with subscription-based access to premium mock exams and features.",
      link: "https://www.nexovea.com",
      stack: [
        "Next.js",
        "TypeScript",
        "TailwindCSS",
...

    {
      ...
      category: "CMS (SaaS)",
      details: "I designed and developed the complete digital infrastructure for Quotient Africa, a modern news media company. The platform includes a scalable content management system (CMS) that allows editors and journalists to create, manage, and publish articles in real time. It supports rich media content, category-based publishing, and optimized content delivery for high-traffic scenarios.\n\nThe system is built with performance and scalability in mind, featuring server-side rendering for SEO, fast load times, and a responsive user interface for mobile-first audiences. On the backend, it handles content storage, user roles, and publishing workflows, while integrating cloud services for reliability and global accessibility.\n\nThis solution empowers Quotient Africa to operate as a fully digital-first media company, streamlining editorial workflows and enhancing content reach across Africa and beyond.",
